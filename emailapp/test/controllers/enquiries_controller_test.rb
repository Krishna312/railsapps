...
class EnquiriesControllerTest < ActionController::TestCase
  ...
  test "should create enquiry" do
    assert_difference('Enquiry.count') do
      post :create, enquiry: { email: @enquiry.email, message: @enquiry.message, mobile: @enquiry.mobile, name: @enquiry.name, responded: @enquiry.responded, subject: @enquiry.subject }
    end
  ...
  test "should update enquiry" do
    patch :update, id: @enquiry, enquiry: { email: @enquiry.email, message: @enquiry.message, mobile: @enquiry.mobile, name: @enquiry.name, responded: @enquiry.responded, subject: @enquiry.subject }
    assert_redirected_to enquiry_path(assigns(:enquiry))
  end
